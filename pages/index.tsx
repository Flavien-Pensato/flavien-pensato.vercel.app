...
const Home = () => {
  ...
  const experiences: Experience[] = [
    {
      ...
      startAt: new Date("2021-07-16"),
      endAt: new Date("2021-05-12"),
    },
    {
      title: "Unow",
    ...
    },
    {
      ...
      startAt: new Date("2017-03-9"),
      endAt: new Date("2019-03-09"),
    },
    {
      title: "Expert Meteor",
    ...
    },
    {
      ...
      startAt: new Date("2012-09-24"),
      endAt: new Date("2017-07-01"),
    },
  ];
  ...
  return (
    <Landing
      data={{
        meta,
        presentationTitle: "Salut,<br />Je m&apos;appelle Flavien&nbsp;Pensato",
