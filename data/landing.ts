...
export const meta: MetaData = {
	...
	keywords:
		"Flavien, Pensato, Lyon, React, Nextjs, Meteor, Devfront, Fullstack",
...
export const experiences: Experience[] = [
	{
		title: "Homeserve",
		subTitle:
			"Freelance, Javascript, React, Ava, Puppeteer, Typescript, NodeJS, NestJS",
		contents: [
			'<a href="https://www.homeserve.fr/" target="_blank" rel="noreferrer" title="Homeserve">Homeserve</a> se positionnent comme un partenaire de confiance pour la gestion des urgences et l’entretien des domiciles.',
			"J'y travaille en tant que consultant orienté front. Notre mission consiste à la création de tunnel d'acquisition pour la Belgique ainsi que la France.",
		],
		startAt: "2023-10-03",
	},
	{
